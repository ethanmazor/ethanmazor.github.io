...
/**
 * Add a NIGHTVISION item at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the nightvision.
 */
...
void add_teleporter(int x, int y, int dest_x, int dest_y);
